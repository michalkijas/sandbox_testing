...
import com.example.spring.domain.books.service.BookServiceClientWithTemplate
...
@ContextConfiguration(classes = BookServiceClientWithTemplate)
@AutoConfigureWebClient(registerRestTemplate = true)
@RestClientTest
class F_RestClientTest_Template_Spec extends TestBaseSpec {

    @Autowired
    private BookServiceClientWithTemplate client
